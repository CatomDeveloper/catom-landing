...
const CTA: React.FC = () => {
  return (
    <section className="py-32 px-8 text-center max-w-4xl mx-auto">
      ...
      <p className="text-xl text-on-surface-variant mb-12">The exhibition is waiting. Join the select few who are defining the digital landscape with CatomDeveloper.</p>
