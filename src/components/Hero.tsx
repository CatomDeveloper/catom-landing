        ...
        <div className="lg:col-span-8 relative rounded-4xl overflow-hidden min-h-[520px] lg:min-h-[620px] group">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            ...
            <p className="text-ink-2 text-sm md:text-base max-w-lg">
              Crafting digital exhibitions through software excellence —
              experiences that define the next generation.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <div className="micro-label mb-2">Developer Team</div>
                <div
                ...
                <div className="text-ink-3 text-xs mt-1 tracking-wide">
                  {" "}
                  Tamil Nadu · India
                </div>
              </div>
